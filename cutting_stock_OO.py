...
--- STILL need to work on removing dependdencies on numpy ---
'''
import json
import numpy as np
...
class stock_cutting():
	...
	def __init__(self, request, sheet_size, sheet_margin, part_margin, order_option = 0):
	...
	def ordered_parts_list(self):
		...
		check the order_option parameter and can use 
		different orderings if it's 1,2, etc... 
		(would need to define those orderings, though)
		'''
